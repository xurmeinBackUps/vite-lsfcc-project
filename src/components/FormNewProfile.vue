<template>
  <v-card color="orange">
    <v-form>
      ...
      <v-text-field v-model="employmentDates" variant="outlined" label="Employment Dates"></v-text-field>

      <v-text-field v-model="lifetime" variant="outlined" label="Birth Year -- Death Year"></v-text-field>
